      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-600">
            Durable workbook orchestration
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
          ...
          <div className="px-6 py-5">
            ...
            <button
              ...
              className="w-full px-4 py-3 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 border border-gray-300 rounded-md transition-colors"
            >
              Install MCP...
            </button>
          </div>
